// src/app/modules/pharmacy/medicine-form/medicine-form.component.ts
//
// FIX: Added styleUrls (was missing, causing a potential CLI warning).
// All logic remains unchanged from original.
...
@Component({
  ...
  // FIX: styleUrls was missing in the original component decorator
...
export class MedicineFormComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    // Force active=true on save (soft-delete is separate action)
